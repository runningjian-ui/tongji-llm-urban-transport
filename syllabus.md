...
**上课时间**：每周五 · 14:00-15:30（90 分钟）· 2026/9/18 - 2027/1/8

> 注：跳过国庆假期（10/2）和元旦假期（1/1）

| 周次 | 日期 | 内容 | 备注 |
|---|---|---|---|
| W1 | 9/18（五） | 第 1 讲：导论 + Grounded AI | 立方法论 |
| W2 | 9/25（五） | 第 2 讲：LLM 内部机理 | + Lab 1 预告 |
| — | 10/2（五） | **国庆假期（停课）** | 调休 |
| W3 | 10/9（五） | 第 3 讲：推理大模型 | |
| W4 | 10/16（五） | 第 4 讲：Prompt + 适配 | + Lab 1（部署 LLM） |
| W5 | 10/23（五） | 第 5 讲：RAG 进阶 | + 专家课 #1 / + Lab 2 |
| W6 | 10/30（五） | 第 6 讲：Agent | |
| W7 | 11/6（五） | 第 7 讲：多智能体 | |
| W8 | 11/13（五） | 第 8 讲：多模态 VLM | |
| W9 | 11/20（五） | 第 9 讲：端到端 AD + 世界模型 | + 专家课 #2 / + Lab 4 |
| W10 | 11/27（五） | 第 10 讲：交通治理全景 | + Lab 3 |
| W11 | 12/4（五） | 第 11 讲：评测 | |
| W12 | 12/11（五） | 第 12 讲：治理 + 前沿 | |
| W13 | 12/18（五） | 项目 Proposal 提交 | Office Hour |
| W14 | 12/25（五） | 项目中期汇报 | Office Hour |
| — | 1/1（五） | **元旦假期（停课）** | 调休 |
| W15 | 1/8（五） | **项目终期汇报** | 最终考核 |
